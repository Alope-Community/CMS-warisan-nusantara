...
//
import { IconLoader, IconLockFill, IconPersonFill } from "@irsyadadl/paranoid";
...
export default function Login() {
  ...
  return (
    <>
      {isLoading && (
        <section className="absolute inset-0 bg-black/20 z-50 flex items-center justify-center">
          <IconLoader className="text-red-500 w-20 h-20 animate-spin" />
        </section>
      )}
